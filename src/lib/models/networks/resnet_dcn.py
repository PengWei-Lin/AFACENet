...
class CSPBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.part1_chnls = int(inplanes * 0.5)
        self.part2_chnls = inplanes - self.part1_chnls
        self.block = BasicBlock(inplanes=self.part2_chnls, planes=self.part2_chnls, stride=stride, downsample=downsample)
        self.dwsp = nn.Conv2d(self.part1_chnls, self.part1_chnls, kernel_size=1, stride=2, bias=False)
...
class CSPBottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.part1_chnls = int(inplanes * 0.5)
        self.part2_chnls = inplanes - self.part1_chnls
        self.block = Bottleneck(inplanes=self.part2_chnls, planes=planes, stride=stride, downsample=downsample)
        self.dwsp = nn.Conv2d(self.part1_chnls, self.part1_chnls, kernel_size=1, stride=2, bias=False)
