...
def dlady34(pretrained=True, **kwargs):  # DLA-34
...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        self.attention_head = Dynamic_conv2d(in_planes=3, out_planes=3, kernel_size=3, stride=1, padding=1, bias=False, dilation=1)
...
def get_pose_net(num_layers, heads, head_conv=256, down_ratio=4):
    model = DLASeg('dlady{}'.format(num_layers), heads,
                   pretrained=True,
