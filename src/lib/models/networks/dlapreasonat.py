...
class SAModule(nn.Module):
    def __init__(self, in_size):
        ...
        self.sp_at = nn.Sequential(
            #nn.BatchNorm2d(in_size, momentum=BN_MOMENTUM), with batch normalization is junk
...
def dlapreasonat34(pretrained=True, **kwargs):  # DLA-34
...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        self.attention_head = SAModule(in_size=3)
...
def get_pose_net(num_layers, heads, head_conv=256, down_ratio=4):
    model = DLASeg('dlapreasonat{}'.format(num_layers), heads,
                   pretrained=True,
