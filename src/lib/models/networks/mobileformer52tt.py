...
class Mobilex(nn.Module):
    def __init__(self, ks, inp, hid, out, se, stride):
        super(Mobilex, self).__init__()
        self.hid = hid
...
'Unoffical'
class MobileFormer52tt(nn.Module):
    def __init__(self, heads, final_kernel, head_conv):
        super(MobileFormer52tt, self).__init__()
