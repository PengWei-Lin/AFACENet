...
class SKAttention(nn.Module):
    ...
    def __init__(self, channel=3,kernels=[1,3,5,7],reduction=1,group=1,L=32):
        super().__init__()
...
def dlask34(pretrained=True, **kwargs):  # DLA-34
...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        self.attention_head = SKAttention()
...
def get_pose_net(num_layers, heads, head_conv=256, down_ratio=4):
    model = DLASeg('dlask{}'.format(num_layers), heads,
                   pretrained=True,
