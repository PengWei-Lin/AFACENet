...
'Unoffical'
class MobileFormer294(nn.Module):
    def __init__(self, heads, final_kernel, head_conv):
        super(MobileFormer294, self).__init__()
        ...
        self.block0 = nn.Sequential(
            BaseBlock(inp=16, exp=96, out=24, se=None, stride=2, heads=2, dim=192),
            BaseBlock(inp=24, exp=48, out=24, se=None, stride=1, heads=2, dim=192),
        )
        self.block1 = nn.Sequential(
            BaseBlock(inp=24, exp=144, out=48, se=None, stride=2, heads=2, dim=192),
            BaseBlock(inp=48, exp=192, out=48, se=None, stride=1, heads=2, dim=192),
        )
        self.block2 = nn.Sequential(
            BaseBlock(inp=48, exp=288, out=96, se=None, stride=2, heads=2, dim=192),
            BaseBlock(inp=96, exp=384, out=96, se=None, stride=1, heads=2, dim=192),
            BaseBlock(inp=96, exp=576, out=128, se=None, stride=1, heads=2, dim=192),
            BaseBlock(inp=128, exp=768, out=128, se=None, stride=1, heads=2, dim=192),
        )
        self.block3 = nn.Sequential(
            BaseBlock(inp=128, exp=768, out=192, se=None, stride=2, heads=2, dim=192),
            BaseBlock(inp=192, exp=1152, out=192, se=None, stride=1, heads=2, dim=192),
            BaseBlock(inp=192, exp=1152, out=192, se=None, stride=1, heads=2, dim=192),
        )
        ...
        self.ida_up = IDAUp(24, [24, 48, 128, 1152], [2 ** i for i in range(4)])
