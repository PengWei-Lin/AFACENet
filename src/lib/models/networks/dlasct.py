...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        #self.act_attention = SCConvSP(in_channels=2, pooling_r=2)
        #self.dep_attention = SCConvSP(in_channels=1, pooling_r=4)
                ...
                if head_conv > 0:
                    if 'hm' in head:
                        ...
                        fc = nn.Sequential(
                            ...
                            SCConvSP(in_channels=2, pooling_r=2),
                        )
                        fill_fc_weights(fc)
                    else:
                        fc = nn.Sequential(
    ...
    def forward(self, x):
        ...
        for head in self.heads:
            ...
            #elif head == 'act':
                #final_out = self.act_attention(final_out)
            #elif head == 'dep':
                #final_out = self.dep_attention(final_out)
            ret[head] = final_out
