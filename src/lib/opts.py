  ...
  def __init__(self):
    ...
    self.parser.add_argument('--arch', default='dla_34', 
                             help='model architecture. Currently tested'
                                  ...
                                  'dlav0_34 | dla_34 | hourglass | mobilenetv3 |'
                                  'mobilenetv3s | mobilenetv1 | mobilenetv3scsp |' 
                                  'mobilenetv3csp | mobileformer52 | mobileformer96 |'
                                  'mobileformer151 | mobileformer294 | mobileformer508 |'
                                  'mobilevitxxs | mobilevitv2 | mobilevitv3xxs | mobilevitv3d1d0')
