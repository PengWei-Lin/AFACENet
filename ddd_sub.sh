...
python3 main.py --task ddd --exp_id subcnn_dlapreason --arch dlapreason_34 --head_conv 256 --dataset kitti --kitti_split subcnn --batch_size 20 --num_epochs 100 --lr_step 45,60,70,80,90,100 --gpus 0 --num_workers 20
