...
#SPLITS = {'test': 'v1.0-test'}
#SPLITS = {'val': 'v1.0-trainval', 'train': 'v1.0-trainval'}
#SPLITS = {'mini-val': 'v1.0-mini', 'mini-train': 'v1.0-mini'}
SPLITS = {'val': 'v1.0-trainval'}
      ...
      for sensor_name in sample['data']:
        if sensor_name in USED_SENSOR:
          ...
          if DEBUG:
            ...
            cv2.imwrite("../../data/nuscenes/Visaulized_GT/{}.jpg".format(num_images), img_3d)
            cv2.waitKey()
...
# nuScenes mini list 70% train 30% test
'''
SCENE_SPLITS = {
'train':
    ['scene-0061', 'scene-0553', 'scene-0655', 'scene-0757', 'scene-0796', 'scene-1077', 'scene-1094'],
'val':
    ['scene-1100', 'scene-0103', 'scene-0916']
}
'''

# construction:  scene-0165, scene-0268, scene-0274, scene-0001, scene-0005, scene-0022, scene-0031, scene-0036,
#    scene-0038, scene-0047, scene-0048, scene-0049, scene-0056, scene-0058, scene-0061, scene-0203, scene-0210,
#    scene-0211, scene-0225, scene-0230, scene-0099, scene-0108, scene-0109, scene-0071, scene-0344, scene-0345,
#    scene-0352, scene-0356, scene-0357, scene-0358, scene-0373, scene-0378, scene-0247...........
