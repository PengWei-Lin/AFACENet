...
class PoseResDCN(BaseModel):
    ...
    def _make_deconv_layer(self, num_layers, num_filters, num_kernels):
        ...
        for i in range(num_layers):
            ...
            #fc = DCN(self.inplanes, planes, kernel_size=3, stride=1, padding=1, dilation=1, groups=1)
            fc = DeformableConv2d(self.inplanes, planes, kernel_size=3, padding=1, bias=False)
            #fc = DeformConv2d(self.inplanes, planes, kernel_size=3, padding=1, bias=False)
            #fc = DCN(self.inplanes, planes, kernel_size=(3, 3), stride=(1, 1), padding=1, deform_groups=1)
